...
import 'image_border_radius.dart';
import '../../core/utils/converters/date_extensions.dart';

class ItemMovie extends StatelessWidget {
  final MovieEntity _movie;
  ItemMovie(this._movie);
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            ItemSubtitle(
                subtitle: DateParsing(_movie.releaseDate).formattedString())
          ],
        ));
  }
}
